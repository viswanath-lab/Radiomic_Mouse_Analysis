function [grayfeats, feat_names] = grayfilts2(img,WindowSize)
%function grayfeats = grayfilts2(img,WindowSize)
...
feat_names = {'Gray mean','Gray median','Gray std-dev','Gray range'};
